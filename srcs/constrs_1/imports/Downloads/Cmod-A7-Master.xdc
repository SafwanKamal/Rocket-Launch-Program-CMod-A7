...
## Buttons (use internal pull-ups, active-LOW wiring)
#set_property -dict { PACKAGE_PIN M3 IOSTANDARD LVCMOS33 PULLUP true } [get_ports { btn_start }];
#set_property -dict { PACKAGE_PIN L3 IOSTANDARD LVCMOS33 PULLUP true } [get_ports { btn_abort }];
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports { btn_start }]; #IO_L5N_T0_34 Sch=pio[32]
set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports { btn_abort }]; #IO_L5P_T0_34 Sch=pio[33]

## External launch LED (DIP 34 -> E1)
# set_property -dict { PACKAGE_PIN E1 IOSTANDARD LVCMOS33 } [get_ports { led_launch }];
# set_property -dict { PACKAGE_PIN G17 IOSTANDARD LVCMOS33 } [get_ports { led_launch }];

set_property -dict { PACKAGE_PIN W3 IOSTANDARD LVCMOS33 } [get_ports { led_launch }]; #IO_L6N_T0_VREF_34 Sch=pio[34]

## 7-seg segments (DIP 1-7)
## Pins 15 and 16 should remain commented if using them as analog inputs


# Tesing out different pins for a segment. for some reason it is not working
#set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { seg[0] }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { seg[0] }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { seg[0] }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { seg[0] }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]

set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { seg[1] }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { pio3  }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
#set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { pio4  }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pio5  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { pio6  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
...
set_property -dict { PACKAGE_PIN A16 IOSTANDARD LVCMOS33 } [get_ports { seg[2] }]; # a
set_property -dict { PACKAGE_PIN K3  IOSTANDARD LVCMOS33 } [get_ports { seg[3] }]; # b
set_property -dict { PACKAGE_PIN C15 IOSTANDARD LVCMOS33 } [get_ports { seg[4] }]; # c
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { seg[5] }]; # d
set_property -dict { PACKAGE_PIN A15 IOSTANDARD LVCMOS33 } [get_ports { seg[6] }]; # e
#set_property -dict { PACKAGE_PIN B15 IOSTANDARD LVCMOS33 } [get_ports { seg[5] }]; # f
#set_property -dict { PACKAGE_PIN A14 IOSTANDARD LVCMOS33 } [get_ports { seg[6] }]; # g 
